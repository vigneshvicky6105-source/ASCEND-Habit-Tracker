...
function App(){
 ...
 return <div className="shell">
   ...
   {tab==="quests"&&<main><div className="pageHead"><div><div className="eyebrow">CONTROL CENTER</div><h2>MAIN QUESTS</h2><p>Edit your system. Add new quests whenever your priorities change.</p></div><button className="primary" onClick={addTask}><Plus size={17}/> Add quest</button></div><QuestPanel tasks={tasks} local={local} toggle={toggle} edit={editTask} del={deleteTask} lock={toggleLock}/><div className="panel concepts"><div className="panelTitle">CORE CONCEPT ROTATION</div>{CONCEPTS.map(c=><div className="concept" key={c}><span>{c}</span><span>Daily learning target</span></div>)}</div></main>}
